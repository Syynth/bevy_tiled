...
//! with rendering, physics, or custom game logic. Layer 2 (`bevy_tiledmap_core`)
//! provides the entity structure and data; Layer 3 plugins add visual/behavioral
//! components by observing spawning events.
//!
//! ## The Three-Layer Architecture
//!
//! - **Layer 1 (`bevy_tiledmap_assets`)**: Asset loading (.tmx, .tsx, .tx files)
//! - **Layer 2 (`bevy_tiledmap_core`)**: Entity spawning, property merging, events
