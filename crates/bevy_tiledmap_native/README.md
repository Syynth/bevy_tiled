...
The `bevy_tiled` architecture supports multiple rendering backends. This crate reserves the `bevy_tiledmap_native` namespace for when Bevy's built-in tilemap rendering is ready.

## Current Recommendation

**Use [`bevy_tiledmap_tilemap`](../bevy_tiledmap_tilemap) instead** for production rendering. It provides:
...
- Provide the same API as `bevy_tiledmap_tilemap`
