...
//!
//! This example shows how `bevy_tiled_avian` can automatically generate optimized physics
...
fn setup(
    ...
    info!("6. Place the .tmx file at: crates/bevy_tiled_avian/assets/maps/tile_colliders.tmx");
    info!("");
