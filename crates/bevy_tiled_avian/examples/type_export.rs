...
fn main() {
    ...
    // Add bevy_tiled_core (registers TiledClassRegistry)
    app.add_plugins(BevyTiledCorePlugin::default());

    // Add bevy_tiled_avian (registers PhysicsSettings and BodyType)
    app.add_plugins(BevyTiledAvianPlugin::default());
